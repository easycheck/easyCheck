...
public class ResponseCompanyID {
	...
	public ResponseCompanyID(List<Contact> entry_list,
			List<String> relationship_list, String next_offset,
			String result_count, String total_count) {
		super();
